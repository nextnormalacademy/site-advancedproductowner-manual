...
{% include figure image_path="/assets/images/17-feedback-loop-canvas.png" alt="Feedback Loop Canvas von Gerrit Beine" caption="Feedback Loop Canvas von Gerrit Beine" %}
